...
#            self._jacobian = self.__jacobian(self._state_vector)
    ...
    def __f (self, time, state_vector):
        ...
        state_update[6]  = state_vector[24]  
        state_update[7]  = state_vector[25]
        state_update[8]  = state_vector[26]
        state_update[9]  = state_vector[27]
        state_update[10] = state_vector[28]
        state_update[11] = state_vector[29]

        state_update[12] = state_vector[30]  
        state_update[13] = state_vector[31]
        state_update[14] = state_vector[32]
        state_update[15] = state_vector[33]
        state_update[16] = state_vector[34]
        state_update[17] = state_vector[35]
         
        state_update[18] = state_vector[36]  
        state_update[19] = state_vector[37]
        state_update[20] = state_vector[38]
        state_update[21] = state_vector[39]
        state_update[22] = state_vector[40]
        state_update[23] = state_vector[41]

        state_update[24] = J_CRTBP[3,0]*state_vector[6]  + J_CRTBP[3,1]*state_vector[12] + J_CRTBP[3,2]*state_vector[18] + 2.0*state_vector[30]
        state_update[25] = J_CRTBP[3,0]*state_vector[7]  + J_CRTBP[3,1]*state_vector[13] + J_CRTBP[3,2]*state_vector[19] + 2.0*state_vector[31]
        state_update[26] = J_CRTBP[3,0]*state_vector[8]  + J_CRTBP[3,1]*state_vector[14] + J_CRTBP[3,2]*state_vector[20] + 2.0*state_vector[32]   
        state_update[27] = J_CRTBP[3,0]*state_vector[9]  + J_CRTBP[3,1]*state_vector[15] + J_CRTBP[3,2]*state_vector[21] + 2.0*state_vector[33] 
        state_update[28] = J_CRTBP[3,0]*state_vector[10] + J_CRTBP[3,1]*state_vector[16] + J_CRTBP[3,2]*state_vector[22] + 2.0*state_vector[34]
        state_update[29] = J_CRTBP[3,0]*state_vector[11] + J_CRTBP[3,1]*state_vector[17] + J_CRTBP[3,2]*state_vector[23] + 2.0*state_vector[35]       
        
        state_update[30] = J_CRTBP[4,0]*state_vector[6]  + J_CRTBP[4,1]*state_vector[12] + J_CRTBP[4,2]*state_vector[18] - 2.0*state_vector[24]
        state_update[31] = J_CRTBP[4,0]*state_vector[7]  + J_CRTBP[4,1]*state_vector[13] + J_CRTBP[4,2]*state_vector[19] - 2.0*state_vector[25]
        state_update[32] = J_CRTBP[4,0]*state_vector[8]  + J_CRTBP[4,1]*state_vector[14] + J_CRTBP[4,2]*state_vector[20] - 2.0*state_vector[26] 
        state_update[33] = J_CRTBP[4,0]*state_vector[9]  + J_CRTBP[4,1]*state_vector[15] + J_CRTBP[4,2]*state_vector[21] - 2.0*state_vector[27]
        state_update[34] = J_CRTBP[4,0]*state_vector[10] + J_CRTBP[4,1]*state_vector[16] + J_CRTBP[4,2]*state_vector[22] - 2.0*state_vector[28]
        state_update[35] = J_CRTBP[4,0]*state_vector[11] + J_CRTBP[4,1]*state_vector[17] + J_CRTBP[4,2]*state_vector[23] - 2.0*state_vector[29]        
        
        state_update[36] = J_CRTBP[5,0]*state_vector[6]  + J_CRTBP[5,1]*state_vector[12] + J_CRTBP[5,2]*state_vector[18]
        state_update[37] = J_CRTBP[5,0]*state_vector[7]  + J_CRTBP[5,1]*state_vector[13] + J_CRTBP[5,2]*state_vector[19]
        state_update[38] = J_CRTBP[5,0]*state_vector[8]  + J_CRTBP[5,1]*state_vector[14] + J_CRTBP[5,2]*state_vector[20]
        state_update[39] = J_CRTBP[5,0]*state_vector[9]  + J_CRTBP[5,1]*state_vector[15] + J_CRTBP[5,2]*state_vector[21]
        state_update[40] = J_CRTBP[5,0]*state_vector[10] + J_CRTBP[5,1]*state_vector[16] + J_CRTBP[5,2]*state_vector[22]
        state_update[41] = J_CRTBP[5,0]*state_vector[11] + J_CRTBP[5,1]*state_vector[17] + J_CRTBP[5,2]*state_vector[23]
